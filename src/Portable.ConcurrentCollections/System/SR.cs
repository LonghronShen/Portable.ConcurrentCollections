...
namespace System
{
    ...
    internal static class SR
    {
        ...
        public static string ConcurrentDictionary_Arg_ArrayPlusOffTooSmall = "Destination array is not long enough to copy all the items in the collection. Check array index and length.";
