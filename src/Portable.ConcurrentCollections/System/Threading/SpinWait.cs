...
namespace System.Threading
{
    ...
    internal struct SpinWaitEx
    {
        ...
        public void SpinOnce(int sleep1Threshold)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(sleep1Threshold), "ArgumentOutOfRange_NeedNonNegOrNegative1");
            }
        ...
        private void SpinOnceCore(int sleep1Threshold)
        {
            ...
            else
            {
                ...
                //
                int n = ThreadEx.OptimalMaxSpinWaitsPerSpinIteration;
        ...
        public static bool SpinUntil(Func<bool> condition, TimeSpan timeout)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(timeout), "SpinWait_SpinUntil_TimeoutWrong");
            }
        ...
        public static bool SpinUntil(Func<bool> condition, int millisecondsTimeout)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(millisecondsTimeout), "SpinWait_SpinUntil_TimeoutWrong");
            }
            if (condition == null)
            {
